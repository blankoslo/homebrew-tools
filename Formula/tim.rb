class Tim < Formula
  ...
  if OS.mac?
    ...
    url "https://github.com/blankoslo/tim/releases/download/0.0.1/tim-macos.tar.gz"
    sha256 "<MACOS_SHA>"
  elsif OS.linux?
    ...
    url "https://github.com/blankoslo/tim/releases/download/0.0.1/tim-linux.tar.gz"
    sha256 "<LINUX_SHA>"
  end
