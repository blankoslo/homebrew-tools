class Tim < Formula
  ...
  if OS.mac?
    ...
    url "https://homebrew.blank.no/blankoslo/tim/releases/download/0.0.11/tim-osx.tar.gz"
    ...
    url "https://homebrew.blank.no/blankoslo/tim/releases/download/0.0.11/tim-linux.tar.gz"
